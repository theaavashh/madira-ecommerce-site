...
<div class="single-product-container">
    <div class="container">
        <h1 id="singlepagetitle">Product </h1>
        <div class="row">
        ...
        <?php foreach($single_product as $row){ ?>
                ...
                <div class="col-md-2">
                    <div class="product-image">
                        <img src="product-images/<?php echo $row['featured_image'] ?>" alt=""/>
                    </div>
                </div>
...
if(isset($_SESSION['user_role'])){
    ?>
    <div id="review">
    <h1>Rating and Review of  <?php echo $row['product_title']; ?></h1>
    <text id="review-text">Enter your review</text>
    <br>

    <select id="product-select">
        <option value="disable">Select Review</option>
    ...
    <br>
    <text id="review-desc">Write Description</text>
    <br>
    <textarea></textarea>
...
<?php
    ...
    ?>
    <h1 id="review-failed">Please login to review</h1>
    <?php
}
?>
