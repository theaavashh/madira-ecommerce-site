$(document).ready(function(){
    ...
    $('#adminLogin').submit(function(e){
        ...
        if(username == '' && password == ''){
            $('#adminLogin').append('<div class="alert alert-danger alertLogin">Please Fill All The Fields</div>');
        }
        else if(username==''){
            $('#adminLogin').append('<div class="alert alert-danger alertLogin">Please Fill Username Fields</div>');
        }
        else if(password==''){
            $('#adminLogin').append('<div class="alert alert-danger alertLogin"">Please Fill Password  Fields</div>');
        }
            else{
            $.ajax({
                ...
                success: function(response){
                    ...
                    if(res.hasOwnProperty('success')){
                        $('#adminLogin').append('<div class="alert alert-success alertLogin"">Logged In Successfully.</div>');
                        setTimeout(function(){ window.location = URL+'admin/dashboard.php'; }, 1000);
                    }else if(res.hasOwnProperty('error')){
                        $('#adminLogin').append('<div class="alert alert-danger alertLogin ">Username and Password not Matched.</div>');
                    }
                }
            });
        }
