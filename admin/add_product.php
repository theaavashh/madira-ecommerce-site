...
include 'header.php'; ?>
    <div class="admin-content-container">
        ...
        <form id="createProduct" class="add-post-form row" method="post" enctype="multipart/form-data">
            <div class="col-md-9">
                <div class="form-group label-prod">
                ...
                <div class="form-group brand label-prod">
                ...
                <div class="form-group label-prod">
                    ...
                    <textarea class="form-control " name="product_desc" rows="8" cols="80" requried></textarea>
                </div>
            ...
            <div class="col-md-3">
                ...
                <div class="form-group">
                    <input type="submit" class="btn add-new addnewProduct" name="submit" value="Submit">
                </div>
            </div>
        </form>
    </div>
