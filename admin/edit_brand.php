                    ...
                    <div class="row">
                        ...
                        <form id="updateBrand" class="add-post-form col-md-6" method ="POST">
                            ...
                            <div class="form-group">
                                <label id="label-subCategory">Brand Title</label>
                                <input type="text" name="brand_name" class="form-control brand_name" value="<?php echo $row['brand_title']; ?>"  placeholder="Brand Name"  />
                            </div>
                            <div class="form-group">
                                <label id="label-subCategory">Brand Category</label>
                                <?php
                            ...
                            <input type="submit" name="submit" class="btn add-newCategory" value="Update" />
                        </form>
                        <!-- /Form -->
                    </div>
                    <?php
