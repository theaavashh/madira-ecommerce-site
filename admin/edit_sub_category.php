                    ...
                    <div class="row">
                        ...
                        <form id="updateSubCategory" class="add-post-form col-md-6" method ="POST">
                            ...
                            <div class="form-group">
                                <label id="label-subCategory">Sub Category Title</label>
                                <input type="text" name="sub_cat_name" class="form-control sub_category" value="<?php echo $row['sub_cat_title']; ?>"  placeholder="" >
                            </div>
                            <div class="form-group">
                                <label id="label-subCategory">Category</label>
                                <?php
                            ...
                            <input type="submit" name="sumbit" class="btn add-newSubCategory" value="Update" />
                        </form>
                        <!-- /Form -->
                    </div>
                    <?php
