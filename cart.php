            ...
            <div class="col-md-12 clearfix">
                ...
                <?php
                    if(isset($_COOKIE['user_cart'])){
                        ...
                        if(count($result) > 0){ ?>
                                ...
                                <?php foreach($result as $row){ ?>
                                    <tr class="item-row">
                                        ...
                                        <td>Rs.<span class="product-price"><?php echo $row['product_price']; ?></span></td>
                                        <td>
                                        ...
                                        <td>Rs. <span class="sub-total"><?php echo $row['product_price']; ?></span></td>
                                        <td>
                        ...
                        <?php    } ?>
                                    <tr>
                                        <td colspan="5" align="right"><b>TOTAL AMOUNT  (Rs)</td>
                                        <td class="total-amount"></td>
                                    </tr>
                                    </tbody>
                                </table>
                                <a class="btn btn-sm btn-primary continue-shopping" href="<?php echo $hostname; ?>" >Continue Shopping</a>
                                ...
                                <form action="payment.php" class="checkout-form pull-right" method="POST">
                                    ...
                                    <input type="submit" class="btn btn-md btn-success cartbtn" value="Proceed to Checkout">
                                </form>
                                <?php }else{ ?>
                                    <a class="btn btn-sm btn-success pull-right proceed-checkout" href="#" data-toggle="modal" data-target="#userLogin_form" >Proceed to Checkout</a>
                                <?php } ?>
                <?php   }
                    }else{ ?>
