        ...
        <?php if (isset($_POST['save'])) {
            ...
            <form id="createBrand" class="add-post-form col-md-6" method="POST"
                ...
                <div class="form-group">
                    <label id="label-subCategory">Title</label>
                    <input type="text" name="brand_name" class="form-control brand_name" placeholder="Brand Name"/>
                </div>
                <div class="form-group">
                    <label for="" id="label-subCategory">Brand Category</label>
                    <?php
                    $db = new Database();
                ...
                <input type="submit" name="save" class="btn add-newCategory" value="Submit"/></button>
            </form>
            <!-- /Form -->
        </div>
    </div>
